...
#         esc_note.setAlignment(Qt.AlignCenter)
...
#         # requirements:
#         # running  -> radios inactive, start inactive, stop active
#         # wait     -> radios inactive, start inactive, stop active
#         # stopped  -> radios active,   start active,   stop inactive
#         if running:
#             self.radio_production.setEnabled(False)
#             self.radio_debug.setEnabled(False)
#             self.start_btn.setEnabled(False)
...
#         # self.manual_init_btn.setEnabled(not running)
#         # self.unlock_scan_btn.setEnabled(not running)
...
#     #     self.logger.info("UI | Manual init requested (not yet implemented).")
#     #     QMessageBox.information(
#     #         self,
#     #         "Manual init",
#     #         "Manual init is not yet implemented.",
#     #     )
...
#     #     self.logger.info("UI | Unlock scan requested (not yet implemented).")
#     #     QMessageBox.information(
#     #         self,
#     #         "Unlock scan",
#     #         "Unlock scan is not yet implemented.",
#     #     )
